...
namespace YouYou
{
    public delegate void NetWorkSendDataCallBack(HttpCallBackArgs args);
public class HttpRoutine : MonoBehaviour
{
    /// <summary>
    /// Http发送数据的回调委托
    /// </summary>
   ...
   #region 属性
    ...
    /// Web请求回调
    /// </summary>
    private NetWorkSendDataCallBack m_CallBack;
    ...
    public void SendData(string url, NetWorkSendDataCallBack callBack, bool isPost = false, Dictionary<string, object> dic = null)
    {
        if (IsBusy) return;
