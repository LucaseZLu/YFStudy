...
---@field public redTexture UnityEngine.Texture2D @static
---@field public grayTexture UnityEngine.Texture2D @static
---@field public linearGrayTexture UnityEngine.Texture2D @static
---@field public normalTexture UnityEngine.Texture2D @static
...
---@overload fun(x:number, y:number, color:UnityEngine.Color, mipLevel:number)
---@param x number
---@param y number
...
---@overload fun(x:number, y:number, mipLevel:number):
---@param x number
---@param y number
---@return UnityEngine.Color
function m:GetPixel(x, y) end

---@overload fun(u:number, v:number, mipLevel:number):
---@param u number
---@param v number
---@return UnityEngine.Color
...
---@overload fun(width:number, height:number, format:UnityEngine.Experimental.Rendering.GraphicsFormat, hasMipMap:boolean):
---@param width number
---@param height number
---@return boolean
