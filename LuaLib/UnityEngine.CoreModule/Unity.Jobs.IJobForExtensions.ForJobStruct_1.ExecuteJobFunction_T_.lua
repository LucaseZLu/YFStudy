---@class Unity.Jobs.IJobForExtensions.ForJobStruct_1.ExecuteJobFunction_T_ : System.MulticastDelegate
local m = {}
...
Unity.Jobs.IJobForExtensions.ForJobStruct_1.ExecuteJobFunction_T_ = m
return m
