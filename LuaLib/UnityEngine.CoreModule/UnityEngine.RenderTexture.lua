...
---@overload fun(width:number, height:number, depthBuffer:number, format:UnityEngine.Experimental.Rendering.GraphicsFormat, antiAliasing:number, memorylessMode:UnityEngine.RenderTextureMemoryless, vrUsage:UnityEngine.VRTextureUsage, useDynamicScale:boolean): @static
---@overload fun(width:number, height:number, depthBuffer:number, format:UnityEngine.Experimental.Rendering.GraphicsFormat, antiAliasing:number, memorylessMode:UnityEngine.RenderTextureMemoryless, vrUsage:UnityEngine.VRTextureUsage): @static
---@overload fun(width:number, height:number, depthBuffer:number, format:UnityEngine.Experimental.Rendering.GraphicsFormat, antiAliasing:number, memorylessMode:UnityEngine.RenderTextureMemoryless): @static
---@overload fun(width:number, height:number, depthBuffer:number, format:UnityEngine.Experimental.Rendering.GraphicsFormat, antiAliasing:number): @static
---@overload fun(width:number, height:number, depthBuffer:number, format:UnityEngine.Experimental.Rendering.GraphicsFormat): @static
