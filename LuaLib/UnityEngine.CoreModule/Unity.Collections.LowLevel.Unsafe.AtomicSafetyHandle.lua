...
---@param handle Unity.Collections.LowLevel.Unsafe.AtomicSafetyHandle
---@param value boolean
function m.SetBumpSecondaryVersionOnScheduleWrite(handle, value) end
...
---@overload fun(): @static
---@static
---@param ownerTypeNameBytes System.Byte*
---@param byteCount number
---@return number
function m.NewStaticSafetyId(ownerTypeNameBytes, byteCount) end

---@static
---@param staticSafetyId number
---@param errorType Unity.Collections.LowLevel.Unsafe.AtomicSafetyErrorType
---@param messageBytes System.Byte*
---@param byteCount number
function m.SetCustomErrorMessage(staticSafetyId, errorType, messageBytes, byteCount) end

---@static
---@param handle Unity.Collections.LowLevel.Unsafe.AtomicSafetyHandle
---@param staticSafetyId number
---@return Unity.Collections.LowLevel.Unsafe.AtomicSafetyHandle
function m.SetStaticSafetyId(handle, staticSafetyId) end
