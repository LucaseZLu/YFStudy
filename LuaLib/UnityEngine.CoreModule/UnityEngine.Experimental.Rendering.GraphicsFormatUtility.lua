...
---@overload fun(format:UnityEngine.RenderTextureFormat, readWrite:UnityEngine.RenderTextureReadWrite): @static
---@static
...
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return boolean
function m.IsSwizzleFormat(format) end

---@static
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return UnityEngine.Experimental.Rendering.GraphicsFormat
function m.GetSRGBFormat(format) end

---@static
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return UnityEngine.Experimental.Rendering.GraphicsFormat
function m.GetLinearFormat(format) end
...
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return string
function m.GetFormatString(format) end
...
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return boolean
function m.IsAlphaTestFormat(format) end
...
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return boolean
function m.IsXRFormat(format) end
...
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return boolean
function m.IsEACFormat(format) end
...
function m.GetSwizzleR(format) end

---@static
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return UnityEngine.Rendering.FormatSwizzle
function m.GetSwizzleG(format) end

---@static
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return UnityEngine.Rendering.FormatSwizzle
function m.GetSwizzleB(format) end

---@static
---@param format UnityEngine.Experimental.Rendering.GraphicsFormat
---@return UnityEngine.Rendering.FormatSwizzle
function m.GetSwizzleA(format) end
