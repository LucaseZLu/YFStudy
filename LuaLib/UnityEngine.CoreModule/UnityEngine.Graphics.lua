...
---@field public preserveFramebufferAlpha boolean @static
---@field public minOpenGLESVersion UnityEngine.Rendering.OpenGLESVersion @static
...
---@overload fun(index:number, uav:UnityEngine.GraphicsBuffer, preserveCounterValue:boolean) @static
---@overload fun(index:number, uav:UnityEngine.ComputeBuffer) @static
---@overload fun(index:number, uav:UnityEngine.GraphicsBuffer) @static
---@static
---@param index number
...
function m.CreateAsyncGraphicsFence(stage) end
...
---@overload fun(fence:UnityEngine.Rendering.GraphicsFence, stage:UnityEngine.Rendering.SynchronisationStage) @static
---@static
...
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, count:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean, layer:number, camera:UnityEngine.Camera) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, count:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean, layer:number) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, count:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, count:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, count:number, properties:UnityEngine.MaterialPropertyBlock) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, count:number) @static
---@static
---@param mesh UnityEngine.Mesh
---@param submeshIndex number
---@param material UnityEngine.Material
...
---@param lightProbeUsage UnityEngine.Rendering.LightProbeUsage
---@param lightProbeProxyVolume UnityEngine.LightProbeProxyVolume
function m.DrawMeshInstancedProcedural(mesh, submeshIndex, material, bounds, count, properties, castShadows, receiveShadows, layer, camera, lightProbeUsage, lightProbeProxyVolume) end
...
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean, layer:number, camera:UnityEngine.Camera) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean, layer:number) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number, properties:UnityEngine.MaterialPropertyBlock) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number) @static
---@overload fun(mesh:UnityEngine.Mesh, submeshIndex:number, material:UnityEngine.Material, bounds:UnityEngine.Bounds, bufferWithArgs:UnityEngine.GraphicsBuffer) @static
---@static
---@param mesh UnityEngine.Mesh
---@param submeshIndex number
---@param material UnityEngine.Material
...
---@overload fun(topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number) @static
---@static
---@param topology UnityEngine.MeshTopology
---@param vertexCount number
---@param instanceCount number
function m.DrawProceduralNow(topology, vertexCount, instanceCount) end

---@overload fun(topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer) @static
---@overload fun(topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer) @static
---@overload fun(topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.GraphicsBuffer) @static
---@overload fun(topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.GraphicsBuffer, argsOffset:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.GraphicsBuffer) @static
---@static
---@param topology UnityEngine.MeshTopology
---@param bufferWithArgs UnityEngine.ComputeBuffer
---@param argsOffset number
function m.DrawProceduralIndirectNow(topology, bufferWithArgs, argsOffset) end

---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, vertexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, vertexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, vertexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, vertexCount:number, instanceCount:number, camera:UnityEngine.Camera) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, vertexCount:number, instanceCount:number) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, vertexCount:number) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean, layer:number) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number, camera:UnityEngine.Camera) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number, instanceCount:number) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, indexCount:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, vertexCount:number, instanceCount:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, vertexCount:number) @static
---@static
---@param material UnityEngine.Material
---@param bounds UnityEngine.Bounds
...
---@param receiveShadows boolean
---@param layer number
function m.DrawProcedural(material, bounds, topology, vertexCount, instanceCount, camera, properties, castShadows, receiveShadows, layer) end
...
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer) @static
...
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode, receiveShadows:boolean) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock, castShadows:UnityEngine.Rendering.ShadowCastingMode) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera, properties:UnityEngine.MaterialPropertyBlock) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number, camera:UnityEngine.Camera) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number) @static
---@overload fun(material:UnityEngine.Material, bounds:UnityEngine.Bounds, topology:UnityEngine.MeshTopology, indexBuffer:UnityEngine.GraphicsBuffer, bufferWithArgs:UnityEngine.ComputeBuffer) @static
---@overload fun(topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer, argsOffset:number) @static
---@overload fun(topology:UnityEngine.MeshTopology, bufferWithArgs:UnityEngine.ComputeBuffer) @static
---@static
---@param material UnityEngine.Material
---@param bounds UnityEngine.Bounds
...
---@param receiveShadows boolean
---@param layer number
function m.DrawProceduralIndirect(material, bounds, topology, bufferWithArgs, argsOffset, camera, properties, castShadows, receiveShadows, layer) end

---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, sourceDepthSlice:number, destDepthSlice:number) @static
...
---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, scale:UnityEngine.Vector2, offset:UnityEngine.Vector2, sourceDepthSlice:number, destDepthSlice:number) @static
---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, mat:UnityEngine.Material, pass:number) @static
---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, mat:UnityEngine.Material, pass:number, destDepthSlice:number) @static
...
---@overload fun(source:UnityEngine.Texture, mat:UnityEngine.Material, pass:number, destDepthSlice:number) @static
...
---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, mat:UnityEngine.Material) @static
---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, mat:UnityEngine.Material, destDepthSlice:number, ...:UnityEngine.Vector2|UnityEngine.Vector2[]) @static
---@overload fun(source:UnityEngine.Texture, dest:UnityEngine.RenderTexture, mat:UnityEngine.Material, destDepthSlice:number) @static
---@static
---@param source UnityEngine.Texture
---@param dest UnityEngine.RenderTexture
---@param mat UnityEngine.Material
