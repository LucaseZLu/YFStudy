...
---@overload fun(nameID:number, value:UnityEngine.RenderTexture, element:UnityEngine.Rendering.RenderTextureSubElement)
---@param name string
...
---@overload fun(nameID:number, value:UnityEngine.GraphicsBuffer, offset:number, size:number)
---@param name string
---@param value UnityEngine.ComputeBuffer
---@param offset number
---@param size number
