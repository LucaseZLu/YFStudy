...
---@field public shape UnityEngine.LightShape
...
---@field public boundingSphereOverride UnityEngine.Vector4
...
---@field public shadowMatrixOverride UnityEngine.Matrix4x4
