...
---@field public exposure UnityEngine.Texture @static
---@field public probeSize number @static
local m = {}
...
---@overload fun(center:UnityEngine.Vector3, name:string, allowScaling:boolean, tint:UnityEngine.Color) @static
