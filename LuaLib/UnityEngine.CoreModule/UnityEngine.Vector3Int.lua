...
---@field public forward UnityEngine.Vector3Int @static
---@field public back UnityEngine.Vector3Int @static
...
---@overload fun(a:number, b:UnityEngine.Vector3Int): @static
---@static
---@param a UnityEngine.Vector3Int
---@param b UnityEngine.Vector3Int
---@return UnityEngine.Vector3Int
