...
---@static
---@param value fun()
function m.add_tetrahedralizationCompleted(value) end

---@static
---@param value fun()
function m.remove_tetrahedralizationCompleted(value) end

---@static
---@param value fun()
function m.add_needsRetetrahedralization(value) end

---@static
---@param value fun()
function m.remove_needsRetetrahedralization(value) end

---@static
function m.Tetrahedralize() end

---@static
function m.TetrahedralizeAsync() end
