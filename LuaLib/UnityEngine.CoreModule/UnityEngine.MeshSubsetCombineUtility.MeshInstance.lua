...
---@field public additionalVertexStreamsMeshInstanceID number
---@field public enlightenVertexStreamMeshInstanceID number
...
UnityEngine.MeshSubsetCombineUtility.MeshInstance = m
return m
