...
---@overload fun(path:string, finishCallback:fun(arg1:string, arg2:boolean), screenshotCallback:fun(arg1:string, arg2:boolean, arg3:UnityEngine.Profiling.Experimental.DebugScreenCapture), captureFlags:UnityEngine.Profiling.Memory.Experimental.CaptureFlags) @static
---@overload fun(path:string, finishCallback:fun(arg1:string, arg2:boolean), screenshotCallback:fun(arg1:string, arg2:boolean, arg3:UnityEngine.Profiling.Experimental.DebugScreenCapture)) @static
---@static
---@param path string
