...
---@field public IsExecutingJob boolean @static
---@field public JobDebuggerEnabled boolean @static
---@field public JobCompilerEnabled boolean @static
---@field public JobWorkerMaximumCount number @static
---@field public JobWorkerCount number @static
local m = {}
...
---@param innerloopBatchCount number
---@return Unity.Jobs.JobHandle, Unity.Jobs.LowLevel.Unsafe.JobsUtility.JobScheduleParameters
function m.ScheduleParallelForTransformReadOnly(parameters, transfromAccesssArray, innerloopBatchCount) end
...
---@overload fun(type:System.Type, managedJobFunction0:any, managedJobFunction1:any, managedJobFunction2:any): @static
---@overload fun(type:System.Type, managedJobFunction0:any, managedJobFunction1:any): @static
---@overload fun(type:System.Type, managedJobFunction0:any): @static
...
---@overload fun(wrapperJobType:System.Type, userJobType:System.Type, managedJobFunction0:any): @static
---@static
...
---@static
function m.ResetJobWorkerCount() end
