...
---@overload fun(positions:Unity.Collections.NativeArray_1_UnityEngine_Vector3_)
---@overload fun(positions:Unity.Collections.NativeSlice_1_UnityEngine_Vector3_)
