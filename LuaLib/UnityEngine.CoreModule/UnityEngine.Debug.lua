...
---@return number
function m.ExtractStackTraceNoAlloc(buffer, bufferMax, projectFolder) end
...
---@overload fun(logType:UnityEngine.LogType, logOptions:UnityEngine.LogOption, context:UnityEngine.Object, format:string, ...:any|any[]) @static
---@overload fun(logType:UnityEngine.LogType, logOptions:UnityEngine.LogOption, context:UnityEngine.Object, format:string) @static
---@static
---@param format string
---@param ... any|any[]
