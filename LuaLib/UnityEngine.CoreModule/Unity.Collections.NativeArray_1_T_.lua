...
---@overload fun(inputDeps:Unity.Jobs.JobHandle):
---@virtual
...
---@overload fun(src:System.ValueType, dst:System.ValueType[]) @static
...
---@overload fun(src:System.ValueType, dst:System.ValueType[], length:number) @static
...
---@overload fun(src:System.ValueType, srcIndex:number, dst:System.ValueType[], dstIndex:number, length:number) @static
---@static
...
---@return System.ValueType
function m:ReinterpretLoad(sourceIndex) end

---@param destIndex number
---@param data System.ValueType
function m:ReinterpretStore(destIndex, data) end

---@overload fun(expectedTypeSize:number):
---@return System.ValueType
...
function m:GetSubArray(start, length) end
